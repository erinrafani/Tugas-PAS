                ...
                <div class="card-body">
                   <form action="{{route('mobil.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="seat" class="form-control @error('seat') is-invalid @enderror">
                             @error('seat')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="tarif_mobil" class="form-control @error('tarif_mobil') is-invalid @enderror">
                             @error('tarif_mobil')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="tarif_sopir" class="form-control @error('tarif_sopir') is-invalid @enderror">
                             @error('tarif_sopir')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
